...
const Navbar: React.FC = () => {
  ...
  return (
    <header className="fixed top-0 left-0 right-0 z-50 px-4 pt-4">
      <nav className="max-w-screen-xl mx-auto rounded-full bg-white/95 backdrop-blur-md shadow-lg border border-white/20 py-3 px-8">
        ...
        <AnimatePresence>
          {isOpen && (
            <motion.div
              ...
              className="lg:hidden bg-white/95 backdrop-blur-md border border-white/20 rounded-xl shadow-lg mt-4 overflow-hidden"
            >
