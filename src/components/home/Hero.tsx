...
const Hero: React.FC = () => {
  ...
  return (
    <section className="relative min-h-screen flex items-center justify-center pb-24">
      ...
      {/* Circular CTA Button */}
      <motion.button
        className="absolute bottom-8 right-4 md:right-8 w-[130px] h-[130px] rounded-full bg-primary hover:bg-primary-600 text-white flex flex-col items-center justify-center cursor-pointer transition-colors duration-300"
