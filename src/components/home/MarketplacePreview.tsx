      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        ...
        >
          ...
          <h2 className="heading-lg mb-6">
            <span className="text-white">The Future of AI Agents </span>
          ...
          <div className="space-y-6 mb-8">
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="text-white font-medium">Developer Revenue Share</h4>
                <p className="text-gray-400 text-sm">Developers keep 70% of revenue from their agents</p>
              </div>
            </div>
            ...
            <div className="flex gap-3">
              ...
              <div>
                <h4 className="text-white font-medium">Monthly Guarantee Program</h4>
                <p className="text-gray-400 text-sm">Guaranteed income for top-performing agents</p>
              </div>
            </div>
          </div>
        ...
        >
          ...
          <div className="mt-6 p-6 rounded-xl border border-white/10 bg-background/60 backdrop-blur-sm">
            <div className="flex justify-between items-center mb-4">
              <h3 className="text-white font-semibold">Agent Certification</h3>
